...
public class ShutDownDetectionProcessor extends DetectionRequestProcessor {
    ...
    @Override
    public void run() {
        LogAndToastUtil.addLogs(LogAndToastUtil.LOG_STATUS.DEBUG, TAG, "run: stopping all active detection");
        ...
        LogAndToastUtil.addLogs(LogAndToastUtil.LOG_STATUS.DEBUG, TAG, "shutdownSensorDataCapture: stopping detection");
