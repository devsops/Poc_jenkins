...
import com.bosch.pai.comms.operation.DELETERunnable;
import com.bosch.pai.comms.operation.GETRunnable;
import com.bosch.pai.comms.operation.MULTIPARTPOSTRunnable;
import com.bosch.pai.comms.operation.POSTRunnable;
import com.bosch.pai.comms.operation.PUTRunnable;
...
public class CommsManager {
     ...
     * @param commsListener the comms listener
     */
    protected void authenticateUser(final boolean isMasterURL, @NotNull String baseURL, @NotNull final String companyId, @NotNull final String userId,
