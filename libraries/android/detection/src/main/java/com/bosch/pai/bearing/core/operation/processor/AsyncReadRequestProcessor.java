...
/**
 * The type Async read request processor.
 */
public class AsyncReadRequestProcessor implements Runnable {
    ...
    /**
     * Instantiates a new Async read request processor.
     *
     * @param requestID the request id
     * @param event     the event
     * @param sender    the sender
     */
    public AsyncReadRequestProcessor(String requestID, Event event, Sender sender) {
    ...
    public void run() {
        ...
        final RequestReadEvent requestReadEvent = (RequestReadEvent) event;
