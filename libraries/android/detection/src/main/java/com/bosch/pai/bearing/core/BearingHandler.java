...
import com.bosch.pai.bearing.core.operation.processor.AsyncReadRequestProcessor;
import com.bosch.pai.bearing.core.operation.processor.AsyncRetrieveRequestProcessor;
import com.bosch.pai.bearing.core.operation.processor.AsyncUpdateRequestProcessor;
import com.bosch.pai.bearing.core.operation.processor.AsyncUploadRequestProcessor;
import com.bosch.pai.bearing.core.operation.processor.DataCaptureEventProcessor;
import com.bosch.pai.bearing.core.operation.processor.DataCaptureResponseEventProcessor;
import com.bosch.pai.bearing.core.operation.processor.DetectionStartRequestProcessor;
import com.bosch.pai.bearing.core.operation.processor.DetectionStopRequestProcessor;
import com.bosch.pai.bearing.core.operation.processor.GenerateClassifierEventProcessor;
import com.bosch.pai.bearing.core.operation.processor.ShutDownDetectionProcessor;
import com.bosch.pai.bearing.core.operation.processor.ThreshDataEntryEventProcessor;
import com.bosch.pai.bearing.core.operation.processor.ThreshDetectionStartProcessor;
import com.bosch.pai.bearing.core.operation.processor.ThreshDetectionStopProcessor;
