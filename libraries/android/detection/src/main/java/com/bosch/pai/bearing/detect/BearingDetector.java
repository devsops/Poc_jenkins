...
import com.bosch.pai.bearing.detect.errorcode.Constants;
import com.bosch.pai.bearing.detect.operations.Detection;
import com.bosch.pai.bearing.detect.operations.Read;
import com.bosch.pai.bearing.detect.operations.Validation;
...
public final class BearingDetector {
     ...
     * @return the int
     */
    public int invoke(boolean isStart, @NonNull BearingConfiguration bearingConfiguration, BearingData bearingData, @NonNull BearingCallBack bearingCallBack) {
