...
import com.estimote.mgmtsdk.feature.settings.api.Power;
...
public class SensorObservationTest {
    ...
    /*@Test
    public void test1() {
        sensorObservationInstance.registerListener(listener);
    ...
    public void test3() {
        ...
        Mockito.verify(resourceStateManager)
                .updateSensorStateOnActiveModeEnable(Mockito.any(UUID.class), Mockito.any(BearingConfiguration.SensorType.class));
        Mockito.verify(requestResponseHandler)
