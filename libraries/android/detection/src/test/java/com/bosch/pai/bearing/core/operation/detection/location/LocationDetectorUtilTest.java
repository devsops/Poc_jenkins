...
import com.bosch.pai.bearing.algorithm.event.SVMClassifierOutput;
...
public class LocationDetectorUtilTest {
    ...
    public void testStartLocationDetection() {
        ...
        verify(resourceProfiler, Mockito.times(1)).writeDeviceInfo(Mockito.any(Context.class));
    ...
    public void testDetectLocation() {
        ...
        List<BearingConfiguration.SensorType> sensorTypes = new ArrayList<>();
        locationDetectorUtil.detectLocation(snapshotObservations, sensorTypes, BearingConfiguration.Approach.FINGERPRINT);
        locationDetectorUtil.detectLocation(snapshotObservations, sensorTypes, BearingConfiguration.Approach.THRESHOLDING);
