...
public class SiteDetectorUtilTest {
    ...
    private Map<String, Set<SiteDetectionConfiguration>> stringSetMap = new HashMap<>();
    private Map<String, Set<String>> stringSetMaps = new HashMap<>();
    ...
    public void init() throws Exception {
        ...
        PowerMockito.when(persistenceHandlerMock.readSourceIdMapWithConfiguration()).thenReturn(stringSetMap);
        PowerMockito.when(persistenceHandlerMock.readSourceIdMap()).thenReturn(stringSetMaps);
    ...
    public void testMatchWithSnapshot() {
        siteDetectorUtil.matchWithSnapshot(snapshotObservations);
